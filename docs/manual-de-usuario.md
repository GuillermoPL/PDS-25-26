...
![Pantalla de inicio de sesión](./Images/Pantalla_inicial.png)
...
![Pantalla de creación de tablero](./Images/Pantalla_crear_tablero.png)
...
![Seleccionar plantilla YAML](./Images/Crear_plantilla.png)
![Tablero generado desde plantilla](./Images/Plantilla.png)
...
![Configuración de la lista de completadas](./Images/Seleccionar_completadas.png)
![Aspecto visual de una tarjeta completada](./Images/Tarjeta_completada.png)
...
![Creación de tarjeta tipo TASK](./Images/Crear_TASK.png)
...
![Creación de tarjeta tipo CHECKLIST](./Images/Crear_CHECKLIST.png)
...
![Uso de filtros por color y etiqueta](./Images/Filtro.png)
...
![Aspecto del tablero y botón bloquear](./Images/Boton_bloquear.png)
...
![Visualización del historial del tablero](./Images/Historial.png)
...
![Creación de una regla de automatización](./Images/Automatizacion.png)
![Demostración visual de la regla aplicada automáticamente](./Images/Demostracion_automatizacion.png)
